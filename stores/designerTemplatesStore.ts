...
interface DesignerTemplatesStore {
  ...
  addTemplate: (name: string, blocks: DesignerBlock[], branding?: BrandingConfig) => Promise<DesignerTemplate>;
  deleteTemplate: (id: string) => Promise<void>;
  updateTemplate: (id: string, updates: Partial<DesignerTemplate>) => Promise<void>;
}

// Map database row to DesignerTemplate
function mapDbToTemplate(row: any): DesignerTemplate {
  return {
    id: row.id,
    name: row.name,
