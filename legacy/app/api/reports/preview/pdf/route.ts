...
// LEGACY: These imports are stubbed - the actual components were moved
...
const ReportDocument = () => null;
const buildReportData = (body: any, _branding: any, reportId: string) => ({
  title: body.title || "Rapport",
  caseId: body.caseId || reportId,
  date: new Date().toISOString(),
  customer: { name: "", company: "", address: "" },
  investigator: "",
});
const validateReportData = (_body: any) => ({ valid: true, errors: [] });
