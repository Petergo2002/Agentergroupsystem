...
// LEGACY: These types are stubbed - the actual components were moved
...
// Stub template resolver
const resolveTemplateText = (text: string, _data: any) => text;
...
export function buildReportData(
  ...
  const leakAreas: LeakAreaData[] =
    formData.leakAreas?.map((area) => ({
      id: area.id,
      name: area.name,
