...
export const TEMPLATE_VARIABLES: TemplateVariable[] = [
  // Report
  {
    key: "report.title",
    label: "Rapporttitel",
    description: "Rapportens titel",
    category: "report",
    example: "Läckagerapport - Storgatan 5",
  },
  {
    key: "report.status",
    label: "Status",
    description: "Rapportens status",
    category: "report",
    example: "Utkast",
  },
  {
    key: "report.type",
    label: "Typ",
    description: "Rapporttyp (bygg/läckage/elektriker)",
    category: "report",
    example: "Läckage",
  },
  ...
  // Metadata
  {
    key: "client",
    label: "Kund",
    description: "Kundnamn",
    category: "metadata",
    example: "Fastighets AB",
  },
  {
    key: "location",
    label: "Plats",
    description: "Adress/plats",
    category: "metadata",
    example: "Storgatan 5, Stockholm",
  },
  {
    key: "projectReference",
    label: "Projektreferens",
    description: "Jobb-ID eller ordernummer",
    category: "metadata",
  ...
  },
  {
    key: "assignedTo",
    label: "Ansvarig",
    description: "Ansvarig person",
    category: "metadata",
    example: "Johan Andersson",
  },
  {
    key: "priority",
    label: "Prioritet",
    description: "Rapportens prioritet",
    category: "metadata",
    example: "Hög",
  },
  ...
  },
  {
    key: "now",
    label: "Datum & tid",
    description: "Aktuellt datum och tid",
    category: "date",
  ...
  },
  {
    ...
    description: "När rapporten är planerad",
    category: "date",
    example: "2024-01-20",
  },
  {
    key: "dueAt",
    label: "Deadline",
    description: "Rapportens deadline",
    category: "date",
    example: "2024-01-25",
  },
  {
  ...
  },
  {
    key: "week",
    label: "Vecka",
    description: "Aktuell veckonummer",
    category: "date",
    example: "3",
  },
  ...
  // Template
  {
    key: "template.name",
    label: "Mallnamn",
    description: "Namnet på mallen",
    category: "template",
    example: "Läckagerapport Standard",
  },
  {
    key: "template.trade",
    label: "Bransch",
    description: "Mallens bransch",
    category: "template",
    example: "Läckage",
  },
];
...
function resolveVariable(key: string, context: TemplateContext): string {
  ...
  if (report) {
    switch (key) {
      ...
      case "priority":
        return (
          PRIORITY_LABELS[report.metadata?.priority] ||
...
export const DEFAULT_SNIPPETS: TextSnippet[] = [
  // Intro/Sammanfattning
  {
    ...
    content:
      "Denna rapport är utförd av {{assignedTo}} på uppdrag av {{client}}. Inspektionen genomfördes {{scheduledAt}} på {{location}}.",
    category: "intro",
  ...
  },
  {
    ...
    content:
      "Sammanfattningsvis har inspektionen på {{location}} genomförts enligt plan. Nedan följer detaljerade observationer och rekommendationer.",
    category: "summary",
  ...
  // Läckage-specifika
  {
    ...
    content:
      "Vid inspektion av {{location}} har följande observationer gjorts avseende fukt och eventuella läckage. Mätningar har utförts med kalibrerad fuktutrustning.",
    category: "intro",
    trade: "läckage",
  ...
  },
  {
    ...
    content:
      "Undersökningen har genomförts med hjälp av fuktmätare, värmekamera och visuell inspektion. Samtliga mätvärden är dokumenterade i bifogade tabeller.",
    category: "method",
    trade: "läckage",
  ...
  },
  {
    ...
    content:
      "Baserat på genomförda mätningar och observationer rekommenderas följande åtgärder. Prioritering bör ske enligt angiven ordning för att minimera risken för ytterligare skador.",
    category: "conclusion",
    trade: "läckage",
  ...
  // Bygg-specifika
  {
    ...
    content:
      "Denna besiktningsrapport avser {{location}} och är utförd på uppdrag av {{client}}. Besiktningen omfattar de områden som specificerats i uppdragsbeskrivningen.",
    category: "intro",
    trade: "bygg",
  ...
  },
  {
    ...
    content:
      "Besiktningen omfattar visuell kontroll av konstruktion, ytskikt och installationer enligt gällande branschstandard. Dold konstruktion har ej besiktigats om ej annat anges.",
    category: "scope",
    trade: "bygg",
  ...
  // Elektriker-specifika
  {
    ...
    content:
      "Denna elbesiktning är utförd av behörig elektriker på {{location}}. Besiktningen omfattar kontroll av elinstallationer enligt gällande föreskrifter.",
    category: "intro",
    trade: "elektriker",
  ...
  },
  {
    ...
    content:
      "OBS! Arbete med elektriska installationer ska endast utföras av behörig elektriker. Vid osäkerhet, kontakta alltid en auktoriserad elfirma.",
    category: "safety",
    trade: "elektriker",
  ...
  // Generella
  {
    ...
    content:
      "Denna rapport baseras på de förhållanden som rådde vid inspektionstillfället. Dolda fel eller brister som ej var möjliga att upptäcka vid inspektionen omfattas ej av denna rapport.",
    category: "disclaimer",
  ...
  },
  {
    ...
    content:
      "Vid frågor om denna rapport, vänligen kontakta {{assignedTo}}. Referens: {{projectReference}}.",
    category: "contact",
