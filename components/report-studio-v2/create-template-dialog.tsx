...
import { IconBolt, IconDroplet, IconHammer } from "@tabler/icons-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#1a1a1a] border-white/10">
        <DialogHeader>
          ...
          <DialogDescription>
            Ge din mall ett namn och välj bransch. Du kan lägga till sektioner
            efteråt.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-2">
              {[
                {
                  value: "läckage" as ReportTrade,
                  label: "Läckage",
                  icon: IconDroplet,
                  color: "emerald",
                },
                {
                  value: "bygg" as ReportTrade,
                  label: "Bygg",
                  icon: IconHammer,
                  color: "orange",
                },
                {
                  value: "elektriker" as ReportTrade,
                  label: "Elektriker",
                  icon: IconBolt,
                  color: "yellow",
                },
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: isSelected
                        ? `var(--${option.color}-500-20, rgba(16, 185, 129, 0.2))`
                        : undefined,
                      borderColor: isSelected
                        ? `var(--${option.color}-500, #10b981)`
                        : undefined,
                    }}
                  >
                    <Icon
                      className={`w-6 h-6 mx-auto mb-2 ${isSelected ? "text-emerald-400" : "text-gray-400"}`}
                    />
                    <span
