...
export default function DocumentDesigner() {
  const { blocks, addBlock, updateBlock, reorderBlock, deleteBlock } =
    useDocumentDesignerStore();
      ...
      <div className="flex items-center justify-between border-b px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            <Button
              ...
              className="h-8"
              onClick={() =>
                add({ id: crypto.randomUUID(), type: "pageBreak" })
              }
            >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {isSaving ? "..." : hasUnsaved ? "Spara" : "Sparat"}
          </Button>
        </div>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                ...
                value={branding.projectRef}
                onChange={(e) => setBranding({ projectRef: e.target.value })}
              />
            </div>
            <div>
          ...
          <div className="border-t pt-4 mt-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <div className="flex gap-1">
                    <Input
                      type="color"
                      className="h-8 w-8 shrink-0 p-0.5"
                      value={branding.brandColor}
                      onChange={(e) =>
                        setBranding({ brandColor: e.target.value })
                      }
                    />
                    <Input
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    <Input
                      ...
                      onChange={(e) =>
                        setBranding({ accentColor: e.target.value })
                      }
                    />
                    <Input
                      className="h-8 text-xs"
              ...
              <div className="flex items-center justify-between rounded border p-2">
                ...
                <Switch
                  checked={branding.displayLogo}
                  onCheckedChange={(c: boolean) =>
                    setBranding({ displayLogo: c })
                  }
                />
              </div>
            </div>
            ...
            {blocks.length === 0 && (
              <div className="rounded-lg border border-dashed p-6 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Lägg till block från verktygsfältet
                </p>
              </div>
            )}
          </div>
                    ...
                    {b.type === "heading" ? (
                      ...
                      <div>
                        {b.url ? (
                          ...
                          <div className="flex h-16 items-center justify-center rounded border text-[10px] text-muted-foreground">
                            Ingen bild
                          </div>
                        )}
                        {b.caption && (
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Namnge mallen så kan du återanvända designen.
            </DialogDescription>
          </DialogHeader>
