...
import { IconCheck, IconFileText, IconLoader2 } from "@tabler/icons-react";
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-xl gap-0 p-0 overflow-hidden bg-card">
        <DialogHeader className="px-6 py-4 border-b bg-muted/30">
          ...
          <DialogDescription>Välj en mall för att börja.</DialogDescription>
        </DialogHeader>
            ...
            <ScrollArea className="h-[300px] pr-4">
              <div className="grid gap-2">
                {templates.map((template) => {
                  const config =
                    TRADE_CONFIG[template.trade] || TRADE_CONFIG.bygg;
