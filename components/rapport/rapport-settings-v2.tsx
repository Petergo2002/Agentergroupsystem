...
import { IconArrowDown, IconArrowUp, IconFileText, IconPalette, IconPlus, IconSection, IconTrash, IconDeviceFloppy } from "@tabler/icons-react";
...
import type { ReportSectionDefinition, ReportTemplate, ReportSectionType } from "@/lib/types/rapport";
...
export function RapportSettingsV2() {
  ...
  const [newSec, setNewSec] = useState({ title: "", description: "", type: "text" as ReportSectionType });
    ...
    try {
      await Promise.all(
        templates
          ...
          .map(t => updateReportTemplateRecord(t.id, { sections: t.sections.filter(s => s.id !== id) }))
      );
  ...
  const toggleSec = async (sec: ReportSectionDefinition) => {
    ...
    const next = has
      ...
      : [...selTpl.sections, { id: sec.id, title: sec.title, description: sec.description, type: sec.type }];
    try {
      await updateReportTemplateRecord(selTpl.id, { sections: next });
      toast.success(has ? "Sektion borttagen från mall" : "Sektion tillagd i mall");
    } catch (err) {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b px-6 py-4">
        ...
        <p className="text-sm text-muted-foreground">Sektioner, mallar och PDF-styling</p>
      </div>
          ...
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Byggstenar för mallar - sparas i databasen</p>
              </div>
            ...
            <ScrollArea className="flex-1">
              {sLoading ? (
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground mb-2">Inga sektioner ännu</p>
                  <Button variant="outline" size="sm" onClick={() => setNewSecOpen(true)}>
                    ...
                    <Card key={s.id}>
                      <CardHeader className="pb-2">
                        <div className="flex items-start justify-between">
                          ...
                          <Button variant="ghost" size="icon" className="size-7 text-destructive" onClick={() => delSec(s.id)}>
                      ...
                      <CardContent className="pt-0">
                        <Badge variant="outline" className="text-xs">
                          {SECTION_TYPES.find(t => t.value === s.type)?.label || "Text"}
                        </Badge>
                        {s.description && (
          ...
          <div className="h-full grid gap-6 lg:grid-cols-[280px_1fr]">
            ...
            <Card className="flex flex-col">
              <CardHeader className="pb-2 flex-row items-center justify-between space-y-0">
                ...
                <Button size="sm" variant="outline" onClick={() => setNewTplOpen(true)}>
                    ...
                    {templates.map(t => (
                      <button
                        ...
                        className={cn(
                          ...
                          t.id === selTplId ? "border-primary bg-primary/5" : "hover:bg-accent"
                        )}
                      >
                        <div className="font-medium">{t.name}</div>
                        <div className="flex items-center gap-2 mt-1">
                          <Badge variant="outline" className="text-[10px]">{t.trade}</Badge>
                          <span className="text-xs text-muted-foreground">{t.sections.length} sektioner</span>
                        </div>
                      </button>
                    ))}
                    {templates.length === 0 && !tLoading && (
                      <p className="text-sm text-muted-foreground text-center py-4">Inga mallar ännu</p>
                    )}
                  </div>
                </ScrollArea>
              </CardContent>
                  ...
                  <CardContent className="flex-1 min-h-0">
                    <div className="grid gap-4 lg:grid-cols-2 h-full">
                      ...
                      <div className="flex flex-col min-h-0">
                        ...
                        <p className="text-xs text-muted-foreground mb-3">Klicka för att lägga till i mallen</p>
                        <ScrollArea className="flex-1 border rounded-lg p-3">
                          <div className="space-y-2">
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    has ? "border-primary bg-primary/10" : "hover:bg-accent"
                                  )}
                                >
                            ...
                            {sections.length === 0 && (
                              <p className="text-sm text-muted-foreground text-center py-4">Skapa sektioner först</p>
                            )}
                          </div>
                        </ScrollArea>
                      </div>
                      ...
                      <div className="flex flex-col min-h-0">
                        ...
                        <p className="text-xs text-muted-foreground mb-3">Ordna med pilarna</p>
                        <ScrollArea className="flex-1 border rounded-lg p-3">
                          <div className="space-y-2">
                            {selTpl.sections.length === 0 ? (
                              <p className="text-sm text-muted-foreground text-center py-4">Lägg till sektioner från listan</p>
                            ) : (
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Utseende för alla rapporter</p>
              </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Grundinfo (standard)</CardTitle>
                <CardDescription>Dessa värden kan ändras per rapport</CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e => setProfile({ customerName: e.target.value })}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e => setProfile({ projectRef: e.target.value })}
                      placeholder="Fylls i per rapport"
                    />
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => setProfile({ displayLogo: checked })}
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1">
                      <Input
                        ...
                        onChange={e => setProfile({ brandColor: e.target.value })}
                      />
                      <Input
                        value={profile.brandColor}
                        onChange={e => setProfile({ brandColor: e.target.value })}
                ...
                <div>
                  ...
                  <Select value={profile.fontFamily} onValueChange={v => setProfile({ fontFamily: v })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
      ...
      <Dialog open={newSecOpen} onOpenChange={setNewSecOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Sektioner är byggstenar som kan användas i rapportmallar.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
              ...
              <Input
                value={newSec.title}
                onChange={e => setNewSec(p => ({ ...p, title: e.target.value }))}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={e => setNewSec(p => ({ ...p, description: e.target.value }))}
      ...
      <Dialog open={newTplOpen} onOpenChange={setNewTplOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Mallar definierar vilka sektioner som ingår i en rapport.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
              <Label>Namn *</Label>
            ...
            <div>
              <Label>Typ</Label>
              <Select value={newTpl.trade} onValueChange={v => setNewTpl(p => ({ ...p, trade: v as ReportTemplate["trade"] }))}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setNewTplOpen(false)}>Avbryt</Button>
