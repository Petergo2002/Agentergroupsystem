...
export function PDFStructureBuilder() {
  ...
  const activeStructure =
    structures.find((s) => s.id === activeStructureId) || structures[0];
  ...
  const selectedSection = activeStructure.sections.find(
  ...
  const handlePreviewPdf = async () => {
    ...
    try {
      ...
      const previewData = {
        ...
        bakgrund:
          "Detta är en förhandsgranskning av PDF-strukturen. Här visas hur rapporten kommer att se ut med den valda layouten och styling.",
